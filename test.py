...
# ---- import wrapper (robust to package/no-package) ----
try:
    from gasalwrap import GasalAligner, PAlign  # compiled as a top-level module
except ModuleNotFoundError:
    from gasal2.gasalwrap import GasalAligner, PAlign  # type: ignore
